...
{
  public class ContentRecycleBinNotification : BaseNotification, INotificationHandler<ContentMovedToRecycleBinNotification>
  {

    public ContentRecycleBinNotification(IHttpContextAccessor contextAccessor,
